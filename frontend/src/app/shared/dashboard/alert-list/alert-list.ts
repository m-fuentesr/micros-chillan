      ...
      <div class="card-header border-b border-base-200 bg-base-100 z-20">
        <div class="p-4 flex items-center justify-between gap-2 min-w-0">
          ...
          <div class="flex items-center gap-2 min-w-0 flex-1">
            <h2 class="font-bold text-base sm:text-lg flex items-center gap-2 min-w-0 truncate">
      ...
      <div class="card-body p-0 overflow-y-auto custom-scrollbar flex-1 relative bg-base-50/30 min-h-0">
        @if (displayedAlerts().length === 0) {
          ...
          <div class="flex flex-col items-center justify-center py-16 px-4 animate-fade-in">
            ...
            <div class="text-lg font-semibold mb-2">Todo al día</div>
            <p class="text-sm text-base-content/70 text-center">No hay alertas pendientes</p>
          </div>
        } @else {
